...
const baseImages = IMAGE_ASSETS.home.sphere;
// Duplicate images array to create 66 densely packed bubbles on the sphere
const denseImages = [...baseImages, ...baseImages];

const sphereImages: ImageData[] = denseImages.map((src, i) => ({
  id: `sphere-${i + 1}`,
  src,
