...
export default function MapSection() {
  return (
    <section className="relative h-[50vh] min-h-[400px] w-full bg-dark-900 border-t border-white/10">
      {/* Grayscale Map Filter */}
      <div className="absolute inset-0 z-0 filter grayscale contrast-125 brightness-75 bg-dark-900">
        <iframe
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 w-full max-w-md px-4">
        <motion.div
          ...
          className="bg-black/80 backdrop-blur-md border border-gold-400/30 p-8 rounded-2xl text-center shadow-2xl"
        >
          <h3 className="text-2xl font-playfair text-gold-400 mb-2">Visit Our Kitchen</h3>
          <p className="text-gray-300 text-sm mb-4">
            Experience the hygiene and precision behind our culinary art.
            <br /><span className="text-xs text-gray-500">(By Appointment Only)</span>
          </p>
          <a
            href="https://goo.gl/maps/example"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white hover:text-gold-400 border-b border-gold-400 text-sm pb-1 transition-colors"
          >
            Get Directions
          </a>
        </motion.div>
